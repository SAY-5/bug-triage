...
RESOLUTIONS = [
    {
        ...
        "fix_diff": diff(CALC_FILE, "// no zero check", "if (b == 0L) throw new ArithmeticException(\"division by zero\");"),
    ...
    },
    {
        ...
        "fix_diff": diff(CALC_FILE, "private static long INVOCATIONS = 0;", "private static final java.util.concurrent.atomic.AtomicLong INVOCATIONS = new java.util.concurrent.atomic.AtomicLong();"),
        "files_changed": [CALC_FILE],
        "severity": "medium",
        "component": "core",
    ...
    },
    {
        ...
        "fix_diff": diff(PARSER_FILE, "// no null check", "Objects.requireNonNull(expression, \"expression\");"),
    ...
    },
    {
        ...
        "fix_diff": diff(PARSER_FILE, "// no balance check", "if (\"(\".equals(top)) throw new IllegalArgumentException(\"unbalanced parentheses\");"),
        "files_changed": [PARSER_FILE],
        "severity": "high",
        "component": "core",
    ...
    },
    {
        ...
        "fix_diff": diff(PARSER_FILE, "// always operator", "if (c == '-' && num.isEmpty() && (out.isEmpty() || isOperator(out.get(out.size()-1)))) num.append(c);"),
        "files_changed": [PARSER_FILE],
        "severity": "medium",
        "component": "core",
    ...
    },
    {
        ...
        "fix_diff": diff(PARSER_FILE, "// no size check", "if (stack.size() < 2) throw new IllegalArgumentException(\"malformed expression\");"),
        "files_changed": [PARSER_FILE],
        "severity": "medium",
        "component": "core",
    ...
    },
    {
        ...
        "fix_diff": diff(PARSER_FILE, "// no final check", "if (stack.size() != 1) throw new IllegalArgumentException(\"malformed expression\");"),
        "files_changed": [PARSER_FILE],
        "severity": "medium",
        "component": "core",
    ...
    },
    {
        ...
        "fix_diff": diff(VAL_FILE, "// no blank check", "if (raw == null || raw.isBlank()) throw new IllegalArgumentException(\"missing operand: \" + name);"),
    ...
    },
    {
        ...
        "fix_diff": diff(VAL_FILE, "// missing bounds error", "throw new IllegalArgumentException(\"operand \" + name + \" out of range [\" + -MAX_OPERAND + \", \" + MAX_OPERAND + \"]\");"),
        "files_changed": [VAL_FILE],
        "severity": "low",
        "component": "util",
    ...
    },
    {
        ...
        "fix_diff": diff(VAL_FILE, "if (raw == null) throw ...", "if (raw == null || raw.isBlank()) throw new IllegalArgumentException(\"missing field: \" + name);"),
        "files_changed": [VAL_FILE],
        "severity": "medium",
        "component": "util",
    ...
    },
    {
        ...
        "fix_diff": diff(VAL_FILE, "throw nfe;", "throw new IllegalArgumentException(\"operand \" + name + \" is not an integer: \" + raw, nfe);"),
        "files_changed": [VAL_FILE],
        "severity": "low",
        "component": "util",
    ...
    },
    {
        ...
        "fix_diff": diff(SERVER_FILE, "// no catch", "} catch (IllegalArgumentException iae) { respond(ex, 400, iae.getMessage()); }"),
    ...
    },
    {
        ...
        "fix_diff": diff(SERVER_FILE, "// no arith catch", "} catch (ArithmeticException ae) { respond(ex, 422, ae.getMessage()); }"),
        "files_changed": [SERVER_FILE],
        "severity": "high",
        "component": "api",
    ...
    },
    {
        ...
        "fix_diff": diff(SERVER_FILE, "ex.sendResponseHeaders(status, body.length());", "ex.sendResponseHeaders(status, bytes.length);"),
        "files_changed": [SERVER_FILE],
        "severity": "medium",
        "component": "api",
    ...
    },
    {
        ...
        "fix_diff": diff(SERVER_FILE, "out.put(part.substring(0, eq), part.substring(eq + 1));", "if (eq < 0) out.put(part, \"\"); else out.put(part.substring(0, eq), part.substring(eq + 1));"),
        "files_changed": [SERVER_FILE],
        "severity": "medium",
        "component": "api",
    ...
    },
    {
        ...
        "fix_diff": diff(SERVER_FILE, "// no healthz", "server.createContext(\"/healthz\", ex -> respond(ex, 200, \"ok\"));"),
        "files_changed": [SERVER_FILE],
        "severity": "high",
        "component": "api",
    ...
    },
    {
        ...
        "fix_diff": diff(SERVER_FILE, "new InetSocketAddress(8080)", "new InetSocketAddress(args.length > 0 ? Integer.parseInt(args[0]) : 8080)"),
        "files_changed": [SERVER_FILE],
        "severity": "medium",
        "component": "api",
    ...
    },
    {
        ...
        "fix_diff": diff(POM_FILE, "<maven.compiler.release>17</maven.compiler.release>", "<maven.compiler.release>21</maven.compiler.release>"),
    ...
    },
    {
        ...
        "fix_diff": diff(POM_FILE, "<!-- no manifest -->", "<archive><manifest><mainClass>com.example.calc.CalcServer</mainClass></manifest></archive>"),
        "files_changed": [POM_FILE],
        "severity": "high",
        "component": "build",
    ...
    },
    {
        ...
        "fix_diff": diff(TEST_FILE, "// no reset", "@BeforeEach void resetCounter() { Calculator.resetForTests(); }"),
    ...
    },
    {
        ...
        "fix_diff": diff(TEST_FILE, "// no zero test", "assertThrows(ArithmeticException.class, () -> Calculator.div(1L, 0L));"),
        "files_changed": [TEST_FILE],
        "severity": "low",
        "component": "tests",
    ...
    },
    {
        ...
        "fix_diff": diff(TEST_FILE, "// no precedence test", "assertEquals(14.0, ExpressionParser.evaluate(\"2 * (3 + 4)\"));"),
        "files_changed": [TEST_FILE],
        "severity": "low",
        "component": "tests",
    ...
    },
    {
        ...
        "fix_diff": diff(TEST_FILE, "// no blank test", "assertThrows(IllegalArgumentException.class, () -> Validation.parseOperand(\"a\", \"  \"));"),
        "files_changed": [TEST_FILE],
        "severity": "low",
        "component": "tests",
    ...
    },
    {
        ...
        "fix_diff": diff(TEST_FILE, "// no urlencoded test", "assertEquals(\"hi there\", java.net.URLDecoder.decode(\"hi+there\", java.nio.charset.StandardCharsets.UTF_8));"),
        "files_changed": [TEST_FILE],
        "severity": "high",
        "component": "tests",
